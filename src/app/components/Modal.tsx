				...
				return (
					...
					>
						...
						<div className="flex flex-col web:h-[224px] tablet:h-[224px] mobile:h-[181px] justify-center gap-[12px] self-stretch bg-purpleNeutral web:shadow-custom tablet:shadow-none mobile:shadow-none rounded-t-[12px] relative">
							<h2 className="text-left text-whiteNeutral web:text-[32px] tablet:text-[32px] mobile:text-[18px] font-sans font-medium web:pl-[48px] tablet:pl-[48px] mobile:pl-[24px] leading-140">
								{headerTitle}
							</h2>
						...
						<div className="flex justify-between items-start px-[24px] pt-[24px] pb-[0px] self-stretch">
							<div className="flex flex-col gap-[4px]">
								<div className="text-left text-charcoalNeutral font-sans text-[14px] web:font-normal tablet:font-medium mobile:font-normal leading-140">
									{detailTitle}
								</div>
								<div className="text-left text-purpleNeutral font-sans text-[16px] font-bold leading-140">
									{detailHost}
								</div>
							</div>
			...
			case 2:
				return (
					...
					>
						...
						<div className="flex justify-between items-start px-[24px] pt-[24px] pb-[0px] self-stretch">
							<div className="flex flex-col gap-[4px]">
								<div className="text-left text-charcoalNeutral font-sans text-[14px] web:font-medium tablet:font-medium mobile:font-medium leading-140">
									{detailTitle}
								</div>
								<div className="text-left web:text-purpleNeutral tablet:text-purpleNeutral mobile:text-charcoalNeutral font-sans text-[16px] web:font-medium tablet:font-bold mobile:font-bold leading-140 ">
									{detailHost}
								</div>
							</div>
							<CloseButton onClick={() => closeModal(modalNumber)} />
			...
			case 3:
				return (
					...
					>
						...
						<div className="flex flex-col web:h-[224px] tablet:h-[224px] mobile:h-[181px] justify-center gap-[12px] self-stretch bg-purpleNeutral rounded-t-[12px] relative">
							<h2 className="text-left text-whiteNeutral web:text-[32px] tablet:text-[32px] mobile:text-[18px] font-sans font-medium web:pl-[48px] tablet:pl-[48px] mobile:pl-[24px] leading-140">
								{updatedProps.headerTitle}
							</h2>
							<div className="text-whiteNeutral text-[14px] font-sans font-medium web:pl-[48px] tablet:pl-[48px] mobile:pl-[24px] leading-140">
								{updatedProps.headerDescription}
							</div>
							<div className="flex flex-col web:pl-[48px] tablet:pl-[48px] mobile:pl-[24px]">
								<div className="text-whiteNeutral web:text-[16px] tablet:text-[16px] mobile:text-[14px] font-sans font-medium leading-140">
									{updatedProps.headerDate}
								</div>
								<div className="text-whiteNeutral web:text-[16px] tablet:text-[16px] mobile:text-[14px] font-sans font-medium leading-140">
						...
						<div className="flex justify-between items-start px-[24px] pt-[24px] pb-[0px] self-stretch">
							<div className="flex flex-col gap-[4px]">
								<div className="text-left web:text-charcoalNeutral tablet:text-charcoalNeutral mobile:text-purpleNeutral font-sans web:uppercase tablet:normal-case mobile:normal-case web:text-[16px] tablet:text-[14px] mobile:text-[14px] web:font-normal tablet:font-normal mobile:font-medium leading-140">
									{updatedProps.detailTitle}
								</div>
								<div className="text-left web:text-purpleNeutral tablet:text-purpleNeutral mobile:text-charcoalNeutral font-sans text-[16px] web:font-bold tablet:font-bold mobile:font-medium leading-140">
